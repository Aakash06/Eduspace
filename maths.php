        ...
        $(document).ready(function () {
            ...
            $(".su").click(function () {
                ...
                if (num == 15) {
                    ...
                    localStorage.setItem("topic", "Mathematics");
...
<div style="background-color: white; overflow:hidden;">
    ...
    <div id="quiz screen"
         style="margin-top:40px;margin-left:auto;margin-right:auto;margin-bottom:60px;width:80%;background-color:palegoldenrod;overflow:hidden;">
        ...
        <form method="post">
            <?php
            $query = "select * from questionbank where subjectno=2 order by rand() limit 15;";
