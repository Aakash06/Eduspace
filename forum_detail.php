...
?>
<div style="overflow: hidden; font-size:2em; width:95%; margin-left:auto; margin-right:auto; margin-top:120px; font-weight:bold; margin-bottom:5px;">
    <span><?php echo $qrw["Ques"]; ?></span></div>


<hr style="width:95%; margin:0px auto 0px auto; color:#000; padding-bottom:4px;"/>

<div class="user_ques container">
<span class="forum_img"> <img src="upload/<?php echo $qrow["Photo"]; ?>" class="img-circle"
                              style="width:70px; margin-top:10px; margin-left:37px; margin-right:auto;" height="70px"/>
<div class="user_name"><?php echo $qrow["Name"]; ?></div>
<div class="date"><?php echo $qrw["dateTime"]; ?></div></span>
    <div class="edit_delete_but" style="display:none;"><span class="glyphicon glyphicon-chevron-down"
                                                             style="font-size:1.5em; float:right;"></span>
    ...
    <div class="q q_edit" style="display:none;"><textarea name="edit_qq" cols="110"
                                                          rows="3"><?php echo $qrw["QuesBody"]; ?> </textarea>
...
<div class="ans_text" style="clear:both; display:none; margin-left:5%; margin-top:70px;">
    <form id="submit_but" action="submit_forum.php">
        <textarea name="aastha" cols="50" rows="8" style="width:90%;"
...
<br/>
<div style="overflow: hidden; font-size:2em; width:95%; margin-left:auto; margin-right:auto; margin-top:10px; font-weight:bold; margin-bottom:5px;">
...
<span class="forum_img"> <img src="upload/<?php echo $qre["Photo"]; ?>" class="img-circle"
                              style="width:70px; margin-top:10px; margin-left:37px; margin-right:auto;" height="70px"/>
...
<div class="date"> <?php echo $qr["dateTime"]; ?></div></span>
        ...
        <div class="q q_edit" style="display:none;"><textarea name="edit_qq" cols="110"
                                                              rows="3"><?php echo $qr["Reply"]; ?> </textarea>
            <div class="submit_edit">Submit</div>
        </div>
    </div>
<?php } ?>
