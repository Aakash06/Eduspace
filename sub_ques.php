	...
	{ 
	 $query2="SELECT * from forum ";
      $id=$_SESSION["id"];
	   ...
	   $ins= $count+1;
	$qq="insert into forum values($ins,'$x','$z','$y',$id,CURRENT_TIMESTAMP);" ;
	$v=mysql_query($qq);
	?>
    <div class="submit_foru"><span class="glyphicon glyphicon-ok-sign s"></span>
    <br />Your question has been submitted successfully.<br />
    Thank you.</div>
	<?php }
else{
	?>
    <div class="submit_forum"><span class="glyphicon glyphicon-alert s"></span>
    <br />You are not logged in. You need to login to ask question.<br />
