...
<div class="forum_body" style="background-color:white;">
    <a href="ask.php" style="text-decoration:none;">
        <div class="Ans" style="clear:both; margin-top:5px;"> Ask a Question</div>
    </a>
    <div class="forum_content">
        ...
        <div class="forum_topics_content">
            ...
            <div class="f">
                ...
                <a href="forum_topic.php?q=Admission" style="text-decoration:none;  color:black;">
                    <div class="topics_options">Admissions</div>
                </a>

                <a href="forum_topic.php?q=Fees" style="text-decoration:none; color:black;">
                    <div class="topics_options">Fees</div>
                </a>
                <a href="forum_topic.php?q=Facilities" style="text-decoration:none; color:black;">
                    <div class="topics_options">Facilities</div>
                </a>
                <a href="forum_topic.php?q=Government/Private Schools" style="text-decoration:none; color:black;">
                    <div class="topics_options">Government/Private Schools</div>
                </a>
                <a href="forum_topic.php?q=College Affiliation" style="text-decoration:none; color:black;">
                    <div class="topics_options">College Affiliation</div>
                </a>
                <a href="forum_topic.php?q=Hostel" style="text-decoration:none; color:black;">
                    <div class="topics_options">Hostel</div>
                </a>
                <a href="forum_topic.php?q=Transport Facility" style="text-decoration:none; color:black;">
                    <div class="topics_options">Transport Facility</div>
                </a>
                <a href="forum_topic.php?q=Stream" style="text-decoration:none; color:black;">
                    <div class="topics_options">Stream</div>
                </a>
                <a href="forum_topic.php?q=School Board" style="text-decoration:none; color:black;">
                    <div class="topics_options">School Board</div>
                </a>
            </div>
        </div>
            ...
            <div class="f">
                ...
                <a href="forum_detail.php?qid=<?php echo $qr['Qid']; ?>" style="text-decoration:none;">
                    <div class="each_review_div lp">
                        <span> <img src="upload/<?php echo $v['Photo']; ?>" class="img-circle img-adjust"
                                    style="float:left; margin-top:4px;"/> </span>
                        <div class="lp1" style="float:left; padding-left:5px;"><span
                                    class="username_detail_review"> <?php echo $v['Name']; ?></span>
                            <div class="date_time_forum"><?php echo $qr['dateTime']; ?></div>
                        </div>
