...
<div class="filter" id="filter_for_college" style="display:none;">
    ...
    <div class="filter_content">
        ...
        <div class="sp1 opt">Swimming Pool<span class="glyphicon glyphicon-ok tick c1" style="display:none;"></span>
        </div>
        ...
        <div class="ac1 opt">Air Conditioned<span class="glyphicon glyphicon-ok tick m1" style="display:none;"></span>
        </div>
    ...
    <div class="filter_content">
        ...
        <div class="govt1 opt">Government Colleges<span class="glyphicon glyphicon-ok tick g1"
                                                        style="display:none;"></span></div>
        <div class="pvt1 opt">Private Colleges<span class="glyphicon glyphicon-ok tick h1" style="display:none;"></span>
        </div>
    </div>
    <br>
    ...
    <div class="filter_content">
        ...
        <div class="state opt">State University<span class="glyphicon glyphicon-ok tick l1"
    ...
    <div class="filter_content">
        ...
        <div class="opt"><span class="glyphicon glyphicon-star star"></span><span
                    class="glyphicon glyphicon-star star"></span>&nbsp; stars
        </div>
        <div class="opt"><span class="glyphicon glyphicon-star star"></span>
            <span class="glyphicon glyphicon-star star"></span>
            <span class="glyphicon glyphicon-star star"></span>&nbsp; stars
        </div>
        <div class="opt"><span class="glyphicon glyphicon-star star"></span>
            <span class="glyphicon glyphicon-star star"></span>
            <span class="glyphicon glyphicon-star star"></span>
...
<div class="filter1 filter" id="filter_for_others" style="display:none;">
    ...
    <div class="filter_content">
        ...
        <div class="sclass opt">Smart Classes<span class="glyphicon glyphicon-ok tick f" style="display:none;"></span>
        </div>
        <div class="ac opt">Air Conditioned<span class="glyphicon glyphicon-ok tick m" style="display:none;"></span>
        </div>
        <div class="tf opt">Transport Facility<span class="glyphicon glyphicon-ok tick n" style="display:none;"></span>
        </div>
    ...
    <div class="filter_content">
        ...
        <div class="govt opt">Government Schools<span class="glyphicon glyphicon-ok tick g"
                                                      style="display:none;"></span></div>
        <div class="pvt opt">Private Schools<span class="glyphicon glyphicon-ok tick h" style="display:none;"></span>
        </div>
    ...
    <div class="filter_content">
        <div class="coed opt">Co-Education<span class="glyphicon glyphicon-ok tick j" style="display:none;"></span>
        </div>
