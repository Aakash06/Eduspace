...
<div id="quiz screen" style="margin-top:40px;margin-left:auto;margin-right:auto;margin-bottom:60px;width:80%;background-color:palegoldenrod;overflow:hidden;border-radius:8px;">

	<center>
    <div id="start_quiz" style="width:230px;background-color:#0C6;color:ghostwhite;border:1px solid white;border-radius:5px;padding:15px 25px;margin-top:50px;margin-bottom:50px;font-size:2.5em;cursor:pointer;">
		Start Quiz !
	</div>
    </center>
