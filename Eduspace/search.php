            ...
            $(".test").bind('toggledit2', function (event, p1) {
                ...
                if (arrt.length == 0 && arr.length == 0) {
                    ...
                    $('.block').each(function () {
                        ...
                        var ftemp = 0;
                        //alert(arrvalues);
                        for (var i = 0; i < arrvalues.length; i++) {   //alert('for loop -> ith value: '+i+'; '+arrvalues[i]);
...
?>
<center>
    <div style="font-family: 'Bree Serif', serif; font-size:2.5em; margin-top:90px;">Search Results</div>
</center>
<br>
<center>
    <div style="font-family: 'Indie Flower', cursive; font-size:2em;"><?php echo $m ?></div>
</center>
...
<div class="sort_type">
    <center>
        <div class="glyphicon glyphicon-chevron-down aa" style="display:none;"></div>
    </center>
...
<div class="filter" id="filter_for_college" style="display:none;">
    ...
    <div class="filter_content">
        <div class="sports1 opt">Sports<span class="glyphicon glyphicon-ok tick a2 test" style="display:none;"></span>
        </div>
        <div class="sp1 opt">Swimming Pool<span class="glyphicon glyphicon-ok tick c1 test"
                                                style="display:none;"></span></div>
        <div class="music1 opt">Music<span class="glyphicon glyphicon-ok tick d1 test" style="display:none;"></span>
        </div>
        <div class="dance1 opt">Dance<span class="glyphicon glyphicon-ok tick e1 test" style="display:none;"></span>
        </div>
        <div class="host opt">Hostel<span class="glyphicon glyphicon-ok tick f1 test" style="display:none;"></span>
        </div>
        <div class="ac1 opt">Air Conditioned<span class="glyphicon glyphicon-ok tick m1 test"
                                                  style="display:none;"></span></div>
    ...
    <div class="filter_content">
        ...
        <div class="govt1 opt">Govt Colleges<span class="glyphicon glyphicon-ok tick g1 test"
                                                  style="display:none;"></span></div>
        <div class="pvt1 opt">Private Colleges<span class="glyphicon glyphicon-ok tick h1 test"
                                                    style="display:none;"></span></div>
    </div>
    <br>
    ...
    <div class="filter_content">
        ...
        <div class="state opt">State University<span class="glyphicon glyphicon-ok tick l1 test"
    ...
    <div class="filter_content">
        <div class="eng opt">Engineering<span class="glyphicon glyphicon-ok tick z1 test" style="display:none;"></span>
        </div>
        <div class="med opt">Medical<span class="glyphicon glyphicon-ok tick y1 test" style="display:none;"></span>
        </div>
...
<div class="filter1 filter" id="filter_for_others" style="display:none;">
    ...
    <div class="filter_content">
        <div class="sports opt">Sports<span class="glyphicon glyphicon-ok tick a test" data-tag="sports"
                                            style="display:none;"></span></div>
        <div class="day opt">Day boarding<span class="glyphicon glyphicon-ok tick b test" data-tag="day"
                                               style="display:none;"></span></div>
        <div class="sp opt">Swimming Pool<span class="glyphicon glyphicon-ok tick c test" data-tag="pool"
                                               style="display:none;"></span></div>
        <div class="music opt">Music<span class="glyphicon glyphicon-ok tick d test" data-tag="music"
                                          style="display:none;"></span></div>
        <div class="dance opt">Dance<span class="glyphicon glyphicon-ok tick e test" data-tag="dance"
                                          style="display:none;"></span></div>
        <div class="sclass opt">Smart Classes<span class="glyphicon glyphicon-ok tick f test" data-tag="smart"
                                                   style="display:none;"></span></div>
        <div class="ac opt">Air Conditioned<span class="glyphicon glyphicon-ok tick m test" data-tag="ac"
                                                 style="display:none;"></span></div>
        <div class="tf opt">Transport Facility<span class="glyphicon glyphicon-ok tick n test" data-tag="transport"
                                                    style="display:none;"></span></div>
    ...
    <div class="filter_content">
        ...
        <div class="govt opt">Govt Schools<span class="glyphicon glyphicon-ok tick g test" style="display:none;"></span>
        </div>
        <div class="pvt opt">Private Schools<span class="glyphicon glyphicon-ok tick h test"
                                                  style="display:none;"></span></div>
        <div class="cs opt">Charity Schools<span class="glyphicon glyphicon-ok tick i test"
                                                 style="display:none;"></span>
        </div>
    </div>
    <br>
    ...
    <div class="filter_content">
        <div class="coed opt">Co-Education<span class="glyphicon glyphicon-ok tick j test" style="display:none;"></span>
        </div>
        <div class="ob opt">Only Boys<span class="glyphicon glyphicon-ok tick k test" style="display:none;"></span>
        </div>
    ...
    if ($x == "name") { //echo "x is name";
        ...
        if ($num > 0) {
            while ($qrow = mysql_fetch_array($data)) {
                ...
                if ($qr2["smartclass"] == "y") {
                    $filter_lists .= ",smartclass";
                }
                if ($qr2["ac"] == "y") {
                    $filter_lists .= ",ac";
                }
                if ($qr2["transport"] == "y") {
                    $filter_lists .= ",transport";
                }
                if ($qr2["govt"] == "y") {
                    $filter_lists .= ",govt";
                }
                ...
                <a href="alldetails.php?id=<?php echo $qrow['id'] ?>" style="text-decoration:none;color:black;">
                    <div class="recent_searches container-fluid block" data-price="<?php echo $qrow["fees"]; ?>"
                         data-tag="<?php echo $filter_lists ?>">
                        <div class="recent_searches_heading"><?php echo $qrow["name"]; ?></div>
                        <img src="<?php echo $qrow['image'] ?>" class="recent_searches_img img-responsive"
                             style="float:left;">
        ...
        if ($n > 0) {
            while ($qr = mysql_fetch_array($d)) {
                ...
                <a href="alldetails.php?id=<?php echo $qr['id'] ?>" style="text-decoration:none;color:black;">
                    <div class="recent_searches container-fluid block" data-price="<?php echo $qr["fees"]; ?>"
                         data-tag="<?php echo $filter_lists ?>">
                        <div class="recent_searches_heading"><?php echo $qr["name"]; ?></div>
                        <img src="<?php echo $qr['image'] ?>" class="recent_searches_img img-responsive"
                             style="float:left;">
