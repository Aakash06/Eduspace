                    ...
                    <div class="contact_left">
                            ...
                            <div class="map">
                                ...
                                <small>
                                    <a href="https://maps.google.co.in/maps?f=q&amp;source=embed&amp;hl=en&amp;geocode=&amp;q=Lighthouse+Point,+FL,+United+States&amp;aq=4&amp;oq=light&amp;sll=26.275636,-80.087265&amp;sspn=0.04941,0.104628&amp;ie=UTF8&amp;hq=&amp;hnear=Lighthouse+Point,+Broward,+Florida,+United+States&amp;t=m&amp;z=14&amp;ll=26.275636,-80.087265"
                                       style="font-family: 'Open Sans', sans-serif;color:#555555;text-shadow:0 1px 0 #ffffff; text-align:left;font-size:12px;padding: 5px;">View
                                        Larger Map</a></small>
                            </div>
                        </div>
                        <div class="company_address">
                            ...
                            <p id="p">Phone: (+9111) 225 523 45<br/>
                                Fax: (+91) 8826 00 1234
                                <br/>Email: <a href="mailto:eduspace.helpdesk@gmail.com" style="color: blue">eduspace.helpdesk@gmail.com</a>
                            </p>
                            <p id="p">Follow on: <a href="https://www.facebook.com/JIITbuzz" style="color: blue;">Facebook</a>,
                                <a href="https://twitter.com/spearkapilspear" style="color: blue">Twitter</a></p>
                        </div>
                    </div>
                        ...
                        <div class="contact-form">
                            ...
                            <form method="post" name="myForm">
                                <div>
                                    ...
                                    <span style="color: black;"><input name="userName" type="text" class="textbox"
                                ...
                                <div>
                                    ...
                                    <span style="color: black;"><input name="userEmail" type="text" class="textbox"
