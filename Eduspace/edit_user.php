            ...
            <div class="roww">
                <div class="col-sm6" id="col1">
                    <div class="form_group">
                        <label>Name</label>
                        <input type="text" class="form_control" name="name" value="<?php echo $_SESSION["name"]; ?>"
                               required/>
                    </div>
                    <div class="form_group">
                        <label>E-Mail</label>
                        <input type="email" class="form_control" name="email" value="<?php echo $_SESSION["email"]; ?>"
                               required/>
                    </div>
                    <div class="form_group">
                        <label>Password</label>
                        <input type="password" class="form_control" name="pass" value="<?php echo $_SESSION["pass"]; ?>"
                               required/>
                    </div>
                    <div class="form_group">
                ...
                <div class="col-sm6" id="col2">
                    ...
                    <div class="form_group2">
                        ...
                        <div style="width:50%; float:left;">
                            <label>New</label><br/>
                            <img src="upload/fre.jpg" id="blah"
                                 style="max-width:90px; width: 100%; height: auto; border:1px solid black; padding:2px;"/>
                        </div>
                    </div>
                </div>
