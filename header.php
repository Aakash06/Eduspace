               ...
               <div class="container">
                      ...
                      <div class="navbar-header">
                       <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
                           ...
                           <a class="navbar-brand" href="#hero">
                            ...
                            <span class="brandname">MasterStudy</span>
                        </a>
                    </div>
                ...
                <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-right"><!--YOUR NAVIGATION ITEMS STRAT BELOW-->
                        ...
                        <li><a href="#testimonials"><span class="btnicon icon-bubble"></span>Reviews</a></li>
                       
                        <!--don't forget to replace my email address below with yours-->
                        <li><a href="mailto:shubhanshu12@gmail.com"><span class="btnicon icon-envelope-open"></span>Contact</a></li> 
   <li style="background-color:#03C; opacity:0.9;"><a href="login.php"><span class="btnicon icon-rocket"></span>Login</a></li>
