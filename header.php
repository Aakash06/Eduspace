    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse">
            <ul class="nav navbar-nav navbar-right"><!--YOUR NAVIGATION ITEMS STRAT BELOW-->
                ...
                <li><a href="mailto:shubhanshu12@gmail.com"><span class="btnicon icon-envelope-open"></span>Contact</a>
                </li>
                <li style="background-color:#03C; opacity:0.9;"><a href="login.php"><span
                                class="btnicon icon-rocket"></span>Login</a></li>
