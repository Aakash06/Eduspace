...
<div style="background-color: lightgray; overflow:hidden;">
    ...
    <div id="quiz screen"
         style="margin-top:40px;margin-left:auto;margin-right:auto;margin-bottom:60px;width:80%;overflow:hidden;">

        <
        <div id="start_quiz"
             style="width:80%;background-color:black;color:ghostwhite;border:1px solid cyan;border-radius:5px;padding:15px 25px;margin-top:20px;margin-bottom:50px;font-size:2.5em;cursor:pointer;margin-left:auto;margin-right:auto;">
            Topic -> <span id="topic"></span><br/>
            <div style="font-size:0.6em; margin-top:15px;">Total Questions -> 15<br/>
                Attempted Questions -> <span id="attempt"></span> (Correct : <span id="correct"></span>, Incorrect :
                <span id="wrong"></span>)<br/>
