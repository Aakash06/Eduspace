...
<center>
    <div style="font-family: 'Bree Serif', serif; font-size:2.5em; margin-top:120px; margin-bottom:20px;">Your
        Favorites
    </div>
</center>
<hr style="width:90%;border:2px solid grey;">
<div class="search_result" id="srchd"
     style="margin-top:50px; width:92%; margin-left:auto; margin-right:auto; margin-bottom:50px;">
    <?php
    $uid = $_SESSION['id'];
    ...
    while ($v1 = mysql_fetch_array($d1)) {
		...
		eng, art, man from institutes, filters where institutes.id = '$i' and institutes.id=filters.idinst";
                ...
                <div style="background-color:#F4F7F7;  padding:10px 10px 10px 10px;">
                    <div class="rem" onClick="rev(<?php echo $qrow['Id']; ?>)"><span class="glyphicon glyphicon-remove"
                                                                                     style="color:#F06;"></span>
                    </div>
                    <a href="alldetails.php?id=<?php echo $i ?>" style="text-decoration:none; color:black;">
                        <div class="recent_searches container-fluid" style="">
                            ...
                            <div class="recent_searches_des">
                                ...
                                $behen = $mani['count(*)'];
                                ?>
                                <span style="color:green; font-weight:bold">&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $behen; ?>
                                    Reviews</span>
                            </div>
                            <hr>
                            <b>Features:</b>
