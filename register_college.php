    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#add_facilities').click(function () {
                ...
                var y = +x + 1;
                if (y == 16) {
                    alert('Maximum Facilities Limit Reached !');
                    return;
                }
                var z = "f" + y;
                $('#' + z).show();
...
<div class="container-fluid"
     style="padding-right:15px;padding-left:15px;margin-right:auto;margin-left:auto;background-color:lightgray;">
                        ...
                        <div class="contact-form">
                            ...
                            <form method="post" name="myForm" enctype="multipart/form-data">
                                <div>
                                    ...
                                    <span style="color: black;"><input name="name" type="text" class="textbox"
                                                                       onfocusout="checkname()"></span>
                                    <div style="display:none; font-size:0.8em; margin-top:-5px; margin-bottom: -20px; float:right; padding-right:4%;"
                                         id="wrongname"><p>XX--&nbsp;&nbsp; Enter Valid Name &nbsp;&nbsp;--XX</p></div>
                                </div>
                                <div>
                                    <span style="color: black;"><label>address *</label></span>
                                    <span style="color: black;"><input name="address" type="text" class="textbox"
                                                                       onfocusout="checkaddress()"></span>
                                    <div style="display:none; font-size:0.8em; margin-top:-5px; margin-bottom: -20px; float:right; padding-right:4%;"
                                         id="wrongaddress"><p>XX--&nbsp;&nbsp; Can't Leave This Empty
                                            &nbsp;&nbsp;--XX</p></div>
                                </div>
                                <div>
                                    <span style="color: black;"><label>contact numbers *</label></span>
                                    <span><input name="contact" type="text" class="textbox"
                                                 onfocusout="checkphone()"></span>
                                    <div style="display:none; font-size:0.8em; margin-top:-5px; margin-bottom: -20px; float:right; padding-right:4%;"
                                         id="wrongphone"><p>XX--&nbsp;&nbsp; Can't Leave This Empty &nbsp;&nbsp;--XX</p>
                                    </div>
                                </div>
                                <div>
                                    <span style="color: black;"><label>email *</label></span>
                                    <span><input name="email" type="text" class="textbox"
                                                 onfocusout="checkemail()"></span>
                                    <div style="display:none; font-size:0.8em; margin-top:-5px; margin-bottom: -20px; float:right; padding-right:4%;"
                                         id="wrongemail"><p>XX--&nbsp;&nbsp; Enter Valid EMail &nbsp;&nbsp;--XX</p>
                                    </div>
                                </div>
                                <div>
                                    ...
                                    <div style="display:none; font-size:0.8em; margin-top:-5px; margin-bottom: -20px; float:right; padding-right:4%;"
                                         id="wrongphone"><p>XX--&nbsp;&nbsp; Enter Valid Phone Number
                                            &nbsp;&nbsp;--XX</p></div>
                                </div>
                                <div>
                                    <span style="color: black;"><label>board *</label></span>
                                    <span><input name="board" type="text" class="textbox"
                                                 onfocusout="checkboard()"></span>
                                    <div style="display:none; font-size:0.8em; margin-top:-5px; margin-bottom: -20px; float:right; padding-right:4%;"
                                         id="wrongphone"><p>XX--&nbsp;&nbsp; Enter Valid Phone Number
                                            &nbsp;&nbsp;--XX</p></div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <span><input name="fees" type="text" class="textbox"
                                                 onfocusout="checkfees()"></span>
                                    <div style="display:none; font-size:0.8em; margin-top:-5px; margin-bottom: -20px; float:right; padding-right:4%;"
                                         id="wrongfees"><p>XX--&nbsp;&nbsp; Enter Valid Fees &nbsp;&nbsp;--XX</p></div>
                                </div>
                                <div>
                                ...
                                <div>
                                    ...
                                    <img src="images/fre.jpg" id="blah"
                                         style="max-width:90px; width: 100%; height: auto; border:1px solid black; padding:2px;"/>
                                </div>


                                <div style="margin-top:20px;"><h3 style="text-decoration: underline">Institute Type</h3>
                                </div>
                                ...
                                <input type="checkbox" value="College" name="college"
                                       id="college_check"/>&nbsp;College<br/>

                                <div style="margin-top:20px;"><h3 style="text-decoration: underline">Facilities</h3>
                                </div>
                                <div id="f1" style="margin-bottom:10px"><textarea name="f1"
                                                                                  style="border-radius:5px;width:90%;height:80px;"> </textarea>
                                </div>
                                <div id="f2" style="margin-bottom:10px;display:none;"><textarea name="f2"
                                                                                                style="border-radius:5px;width:90%;height:80px;"> </textarea>
                                </div>
                                <div id="f3" style="margin-bottom:10px;display:none;"><textarea name="f3"
                                                                                                style="border-radius:5px;width:90%;height:80px;"> </textarea>
                                </div>
                                <div id="f4" style="margin-bottom:10px;display:none;"><textarea name="f4"
                                                                                                style="border-radius:5px;width:90%;height:80px;"> </textarea>
                                </div>
                                <div id="f5" style="margin-bottom:10px;display:none;"><textarea name="f5"
                                                                                                style="border-radius:5px;width:90%;height:80px;"> </textarea>
                                </div>
                                <div id="f6" style="margin-bottom:10px;display:none;"><textarea name="f6"
                                                                                                style="border-radius:5px;width:90%;height:80px;"> </textarea>
                                </div>
                                <div id="f7" style="margin-bottom:10px;display:none;"><textarea name="f7"
                                                                                                style="border-radius:5px;width:90%;height:80px;"> </textarea>
                                </div>
                                <div id="f8" style="margin-bottom:10px;display:none;"><textarea name="f8"
                                                                                                style="border-radius:5px;width:90%;height:80px;"> </textarea>
                                </div>
                                <div id="f9" style="margin-bottom:10px;display:none;"><textarea name="f9"
                                                                                                style="border-radius:5px;width:90%;height:80px;"> </textarea>
                                </div>
                                <div id="f10" style="margin-bottom:10px;display:none;"><textarea name="f10"
                                                                                                 style="border-radius:5px;width:90%;height:80px;"> </textarea>
                                </div>
                                <div id="f11" style="margin-bottom:10px;display:none;"><textarea name="f11"
                                                                                                 style="border-radius:5px;width:90%;height:80px;"> </textarea>
                                </div>
                                <div id="f12" style="margin-bottom:10px;display:none;"><textarea name="f12"
                                                                                                 style="border-radius:5px;width:90%;height:80px;"> </textarea>
                                </div>
                                <div id="f13" style="margin-bottom:10px;display:none;"><textarea name="f13"
                                                                                                 style="border-radius:5px;width:90%;height:80px;"> </textarea>
                                </div>
                                <div id="f14" style="margin-bottom:10px;display:none;"><textarea name="f14"
                                                                                                 style="border-radius:5px;width:90%;height:80px;"> </textarea>
                                </div>
                                <div id="f15" style="margin-bottom:10px;display:none;"><textarea name="f15"
                                                                                                 style="border-radius:5px;width:90%;height:80px;"> </textarea>
                                </div>
                                <div style="margin-bottom:10px;overflow:hidden;width:90%;">
                                    <div onclick="add_facilities()" id="add_facilities" data-tag="1"
                                         style="float:left; background-color:green;padding:5px 10px;font-weight:bold;color:white;cursor:pointer;">
                                        Add
                                    </div>
                                    <div onclick="remove_facilities()" id="remove_facilities" data-tag="1"
                                         style="float:right; background-color:red;padding:5px 10px;font-weight:bold;color:white;cursor:pointer;">
                                        Delete
                                    </div>
                                </div>
                                ...
                                <div>
                                    <span style="color:black;"><input type="radio"
                                                                      name="hostel">&nbsp;&nbsp;Hostel</span>
                                </div>
                                <div>
                                    <span style="color:black;"><input type="radio"
                                                                      name="sports">&nbsp;&nbsp;Sports</span>
                                </div>
                                <div>
                                ...
                                <div>
                                    <span style="color:black;"><input type="radio"
                                                                      name="day">&nbsp;&nbsp;Day Boarding</span>
                                </div>
                                <div style="margin-top:10px;">
                                    <span style="color: black;"><label>Type</label></span>
                                    <span style="float:left;color:black;"><input type="radio" name="type"
                                                                                 value="Government" checked>&nbsp;&nbsp;Government</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span
                                            style="float:left;margin-left:20px;color:black;"><input type="radio"
                                                                                                    name="type"
                                                                                                    value="Private">&nbsp;&nbsp;Private</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span
                                            style="float:left;margin-left:20px;color:black;"><input type="radio"
                                                                                                    name="type"
                                                                                                    value="Charity">&nbsp;&nbsp;Charity</span>
                                </div>
                                <div style="display:none;margin-top:10px;" id="affiliated_to">
                                    <span style="color: black;"><label>affiliated to</label></span>
                                    <span style="float:left;color:black;"><input type="radio" name="affil" value="ugc"
                                                                                 checked>&nbsp;&nbsp;UGC</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span
                                            style="float:left;margin-left:20px;color:black;"><input type="radio"
                                                                                                    name="affil"
                                                                                                    value="csir">&nbsp;&nbsp;CSIR</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span
                                            style="float:left;margin-left:20px;color:black;"><input type="radio"
                                                                                                    name="affil"
                                                                                                    value="state">&nbsp;&nbsp;State</span>
                                </div>
                                <div style="display:none;margin-top:10px;" id="stream_selection">
                                    <span style="color: black;"><label>stream</label></span>
                                    <span style="float:left;color:black;"><input type="checkbox" name="eng">&nbsp;&nbsp;Engineering</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span
                                            style="float:left;margin-left:20px;color:black;"><input type="checkbox"
                                                                                                    name="med">&nbsp;&nbsp;Medical</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span
                                            style="float:left;margin-left:20px;color:black;"><input type="checkbox"
                                                                                                    name="art">&nbsp;&nbsp;Law</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span
                                            style="float:left;margin-left:20px;color:black;"><input type="checkbox"
                                                                                                    name="man">&nbsp;&nbsp;Management</span>
                                </div>
                                <div>
                                    <span style="color: black;"><label></label></span>
                                    <span style="float:left;color:black;"><input type="radio" name="coed" value="coed"
                                                                                 checked>&nbsp;&nbsp;Co-Ed</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span
                                            style="float:left;margin-left:20px;color:black;"><input type="radio"
                                                                                                    value="onlygirls"
                                                                                                    name="coed">&nbsp;&nbsp;Only Girls</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span
                                            style="float:left;margin-left:20px;color:black;"><input type="radio"
                                                                                                    name="coed"
                                                                                                    value="onlyboys">&nbsp;&nbsp;Only Boys</span>
                                </div>
