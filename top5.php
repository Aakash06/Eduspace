...
$xm = $_GET['x']; ?>
<center>
    <div style="font-family: 'Bree Serif', serif; font-size:2.5em; margin-top:120px; margin-bottom:20px;">
        Top 5 - <?php if ($xm == 1)
            echo 'Playschools';
        else if ($xm == 2)
            echo "Kindergarten";
...
<div class="search_result" id="srchd"
    ...
    $q1 = "select * from links where IdBuild=$xm order by avgrate desc limit 5;";
    $d1 = mysql_query($q1);
