...
<div class="about_us container-fluid" style="height:auto; text-align:center; margin-top:100px;">
    ...
    <div class="txt">
        Eduspace originated from the idea that there does not exists a website that contains a collaborative information
        about all the playschools, kindergartens, schools and colleges at one place. It makes it easier for the parents
        to know about the facilities and the infrastructure of the institutions and what is happening in the institution
        where they are/will be sending their ward everyday.

        Website can be effectively used by parents and students. The students currently pursuing class 10th can take up
        the proficiency test to know which stream suits them the best. The students who have completed their class 12th
        can be acquainted with the best institutes available.
    </div>
