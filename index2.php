...
<head>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $(".ps").hover(function () {
                //if ($("#kinder").is(':visible') || $("#sch").is(':visible') || $("#coll").is(':visible')) {
            ...
            <div id="kin" style="display:none;">
                <div class="Srch1 Srch">
                    <form method="post">
                        ...
                        <div class="inpt">
                            <input type="text" placeholder="Search..." name="playbox" width="100%" height="50%"
                                   class="sbox ss " id="ss1">
                            <button type="submit" class="Search_button" id="Search_button1" name="su">
                                <span class="glyphicon glyphicon-search"></span>
                            </button>
                            <input type="hidden" name="category" value="playschool">
                    </form>
                    <div class="err container has-error" id="lp1" style="display:none;"><span
        ...
        <div id="kinder" style="display:none;">
            <div class="Srch2 Srch">
                <form method="post">
                    ...
                    <div class="inpt">
                        <input type="text" placeholder="Search..." name="kgbox" width="100%" height="50%"
                               class="sbox2 ss" id="ss2">
                        <button type="submit" class="Search_button" id="Search_button2" name="su1">
                            <span class="glyphicon glyphicon-search"></span>

                        </button>
                        <input type="hidden" name="category" value="kindergarten">
                </form>
                <div class="err container has-error" id="lp2" style="display:none;"><p><span
                                class="glyphicon glyphicon-alert"> <span id="emsg2"></span></span></p></div>
                <?php
                if (isset($_POST["su1"])) {
                    $var1 = $_POST["opt1"];
                    $var2 = $_POST["kgbox"];
    ...
    <div id="sch" style="display:none;">
        <div class="Srch3 Srch">
            <form method="post">
                ...
                <div class="inpt">
                    <input type="text" placeholder="Search..." name="schoolbox" width="100%" height="50%"
                           class="sbox3 ss" id="ss3">
                    <button type="submit" id="Search_button3" class="Search_button" name="su2">
            ...
            <div class="err container has-error" id="lp3" style="display:none;"><p><span
                            class="glyphicon glyphicon-alert"><span id="emsg3"></span></span></p></div>
        </div>
        <?php
        if (isset($_POST["su2"])) {
            $var1 = $_POST["opt2"];
    ...
    <div id="coll" style="display:none;">
        <div class="Srch4 Srch">
            <form method="post"><select id="options4" name="opt3" class="optn">
                ...
                <div class="inpt">
                    <input type="text" name="collegebox" placeholder="Search..." width="100%" height="50%"
                           class="sbox4 ss" id="ss4">
                    <button type="submit" class="Search_button" id="Search_button4" name="su3">
                        <span class="glyphicon glyphicon-search"></span>
                    </button>
                    <input type="hidden" name="category" value="college">

            </form>
            <div class="err container has-error" id="lp4" style="display:none;"><p><span
                            class="glyphicon glyphicon-alert"> <span id="emsg4"></span></span></p></div>
            <?php
            if (isset($_POST["su3"])) {
                $var1 = $_POST["opt3"];
    ...
    <div class="showoff container-fluid">
        <div class="img1">
            <center><img src="images/3.png" class="ig"><br>
                <div class="tex1">Where Learning Begins</div>
            </center>
        </div>
        <div class="img1">
            <center><img src="images/2.png" class="ig" width="50%" height="50%">
                <div class="tex1">School is a building which has four walls with tomorrow inside it.</div>
            </center>
        </div>
        <div class="img1">
            <center><img src="images/1.png" class="ig" width="50%" height="50%">
                <div class="tex1">A college is a place where you explore and find yourself.</div>
            </center>
        </div>
        <br><br><br>
