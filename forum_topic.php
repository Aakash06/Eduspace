...
<div style="margin-top:65px;">
    ...
    while ($qrw = mysql_fetch_array($data)) { ?>
        <div class="each_ques">
            ...
            <a href="forum_detail.php?qid=<?php echo $qrw["Qid"] ?>" style="text-decoration:none;">
                <div class="forum_ques"><?php echo $qrw["Ques"]; ?></div>
            </a>
        </div>
        <?php
