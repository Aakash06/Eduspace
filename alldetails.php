...
height:600px;"></div>
    <div class="content_body" style="margin:0px 2.5% 0px 2.5%; position:relative; border-radius:5px; z-index:1;">
        ...
        <div class="addtofav_button" style="margin-bottom:5px; padding:5px 5px 5px 5px; float:right; font-size:1.2em;"
             onClick="af()"><span class="glyphicon glyphicon-heart heart" style="font-color:red  ; "></span> Add To
            Favourites
        </div>
        <script>
        ...
        <div style="width:32.5%; min-width:180px; padding: 15px 20px;  clear:both; background-color:#006FA4; height:auto; min-height:155px; float:left; ">
            <div class="recent_searches_heading" style="margin-bottom:12px; font-size:2em; color:#F5FAFA;"><span
                        style=" ">
Institute Type 
</span></div>
...
Contact Information
            ...
            <div style="margin-bottom:10px; color:#F5FAFA;">
                ...
                <span style="font-weight:bold;">E-Mail : </span><a href="mailto:info@mtps.in"
                                                                   style="color: blue"><?php echo $v['Email']; ?></a>
            </div>
        </div>
...
Address
            ...
            <div id="floating-panel">
                ...
                <a href="#map" style="text-decoration:none;">
                    <div id="submit" class="Ans" style="clear:both; margin-top:5px;">Locate</div>
                </a>
            </div>
...
Campus
            ...
            <div>
                ...
                while ($val = mysql_fetch_array($dt)) { ?>
                    ...
                    <p>
                    <li><?php echo $val['Facilities']; ?> </li></p>
        ...
        <div style="margin:50px auto 20px auto; padding: 15px 20px; overflow: hidden;">
            <div class="recent_searches_heading" style=" font-size:1.5em; "><span
                        style="font-size:1.5em; overflow: hidden;">
...
Write A Review
            ...
            <div class="detail_review_submit_button" id="sb"
                 style="margin-top:15px; background-color:green; float:left; color:#F5FAFA; padding:5px 5px 5px 5px;">
                Submit
            </div>
        </div>
